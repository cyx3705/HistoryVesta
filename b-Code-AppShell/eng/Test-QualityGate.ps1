...
$activeRoots = @('b-Code-AppShell\src', 'b-Code-Samples')
$excluded = '\\(bin|obj|artifacts|history|b-Publish|z-Package-AppShell)\\'
...
$hotspots = Get-ChildItem -LiteralPath (Join-Path $root 'b-Code-AppShell\src') -Recurse -File |
