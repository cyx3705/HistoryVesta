...
public static class ServiceCommands
{
        ...
        IReadOnlyList<string>? serviceArguments = null)
    {
        ...
        {
            Name = "app.exit",
            Summary = "退出 AppShell 前端与后台服务",
            ConfirmPrompt = _ => "确认退出 AppShell 前端和后台服务？",
            Handler = async ctx =>
            {
                ...
                return frontend.Success
                    ? CommandResult.Ok("AppShell 正在退出")
    ...
    private static string Format(AppShell.Core.Input.GlobalShortcutRegistrationInfo info)
