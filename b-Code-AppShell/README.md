...
3.0.3 是冻结基线；当前源码目标为 3.1.9，当前稳定消费快照仍为 3.1.7。3.1.8 是不受支持的内部过渡版本，
...
.\eng\Publish-AppShellHost.ps1 -Version 3.1.9

# 候选审核通过后部署同一完整快照到 Z
.\eng\Publish-AppShellHost.ps1 -Version 3.1.9 -DeployToZ
```
