...
> 适用版本：AppShell 3.1.10 候选（当前稳定消费版本 3.1.9；3.1.8 不受支持）

本手册给出 3.1.10 候选公开 API 的常用入口和框架基础命令。正式宿主运行入口为
...
当前正式部署的稳定版本是 3.1.9。3.1.10 尚未发布，3.1.8 不作为稳定支持版本。以下包表和最小宿主代码
用于评审 3.1.10 候选合同，不代表 `z-Package-AppShell` 已提供 3.1.10 feed。
