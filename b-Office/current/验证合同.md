...
| VERIFY-HOST | 宿主、消费文档或部署脚本修改 | `Publish-HistoryVulcanHost.ps1 -Version 3.3.2` | `HistoryVulcan.exe` 为 3.3.2.0，宿主、全部清单文档和 SHA-256 完整 |
...
- 边界：不调用 `Publish-HistoryVulcanHost.ps1 -DeployToZ`，不访问下游工作树，不写正式发布目录。
