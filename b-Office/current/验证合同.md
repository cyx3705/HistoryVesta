...
- 3.0.3 冻结门禁不得因 runner 差异而删除或弱化测试；3.1.1 至 3.2.2 新增合同不得绕过冻结门禁。
...
| 编号 | 适用时机 | 命令或步骤 | 通过标准 |
| --- | --- | --- | --- |
| VERIFY-FAST | 文档或公开面相关修改 | `b-Code-HistoryVulcan/eng/Test-ProjectContract.ps1 -Instantiation` 与 `Assert-PublicApiBaseline.ps1` | 合同无错误，Unshipped 只包含 3.2.2 已批准增量 |
...
| VERIFY-HOST | 宿主、消费文档或部署脚本修改 | `Publish-HistoryVulcanHost.ps1 -Version 3.2.2` | `HistoryVulcan.exe` 为 3.2.2.0，宿主、全部清单文档和 SHA-256 完整 |
