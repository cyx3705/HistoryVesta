...
| `submodules` | `bool` | 否 | false | - | true 时联动提交直属 gitlink；命令默认 false，页面默认 true |
| `submsg` | `string` | 否 | - | - | 子模块统一提交描述；空时沿用 msg |

```text
proj.commit name=2026-018-MyAPI msg="更新说明" submodules=true submsg="更新子模块"
```
...
|---|---|---|---|---|---|
| `msg` | `string` | 是 | - | - | 统一提交描述 |
| `submodules` | `bool` | 否 | false | - | true 时联动提交每个项目的直属 gitlink |
| `submsg` | `string` | 否 | - | - | 全部子模块统一提交描述；空时沿用 msg |

```text
proj.commitall msg="每日推送" submodules=true
```
...
|---|---|---|---|---|---|
| `name` | `string` | 是 | - | - | 分支名(= 工作树文件夹名) |
| `submodules` | `bool` | 否 | false | - | true 时先推送直属 gitlink；命令默认 false，页面默认 true |
...
| 参数 | 类型 | 必填 | 默认值 | 允许值 | 说明 |
|---|---|---|---|---|---|
| `submodules` | `bool` | 否 | false | - | true 时先去重推送全部项目的直属 gitlink |
