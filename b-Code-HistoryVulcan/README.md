...
3.0.3 是冻结基线；当前源码目标与正式消费快照均为 3.2.0。3.1.8 是不受支持的内部过渡版本，
...
.\eng\Publish-HistoryVulcanHost.ps1 -Version 3.2.0

# 候选审核通过后部署同一完整快照到 Z
.\eng\Publish-HistoryVulcanHost.ps1 -Version 3.2.0 -DeployToZ
```
